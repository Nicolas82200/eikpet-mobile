...
const styles = StyleSheet.create({
  ...
  input: { borderWidth: 1, borderColor: '#E3D8C4', borderRadius: 8, padding: 12, backgroundColor: 'white', color: '#3A3226' },
  suggestions: {
    borderWidth: 1,
    borderColor: '#E3D8C4',
    borderTopWidth: 0,
  ...
  suggestionItem: { paddingVertical: 10, paddingHorizontal: 12, borderTopWidth: 1, borderTopColor: '#EDE3D0' },
  suggestionText: { color: '#3A3226' },
});
